...
class ReviewService {
  ...
  Future<Map<String, dynamic>> postReview(
    ...
    final url = Uri.parse('${AppConfig.baseUrl}reviews/post');
  ...
  Future<Map<String, dynamic>> getReviews(int jobId) async {
    final url = Uri.parse("${AppConfig.baseUrl}reviews/list");
  ...
  Future<Map<String, dynamic>> updateStatus(int reviewId, String status) async {
    final url = Uri.parse("${AppConfig.baseUrl}reviews/update-status");
