    ...
    if (userId != null && role != null) {
      ...
      if (result['success']) {
        setState(() {
          ...
          totalSaved = resSavedJob['total_saved'] ?? 0;
          savedJobs = resSavedJob['saved_jobs'] != null 
              ? (resSavedJob['saved_jobs'] as List)
                  .map((jobJson) => Job.fromJson(jobJson))
                  .toList()
              : [];
          totalApplied = resAppliedJob['total_applied'] ?? 0;
          appliedJobs = resAppliedJob['applied_jobs'] != null
              ? (resAppliedJob['applied_jobs'] as List)
